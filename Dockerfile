...
RUN sudo apt-get update --yes && sudo apt-get --yes upgrade
RUN sudo apt-get --yes install apache2 libapache2-mod-shib2 libapache2-mod-wsgi-py3
RUN sudo apt-get --yes install git python3-pip unzip
